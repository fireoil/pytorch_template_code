...
# For one-label classification
class FocalLoss_classification(nn.Module):
...
# For segmentation
class FocalLoss_segmentation(nn.Module):
    def __init__(self,
                 alpha=0.25,
                 gamma=2,
                 reduction='mean',
...
if __name__ == '__main__':
    criteria = FocalLoss_segmentation(alpha=1, gamma=2)
